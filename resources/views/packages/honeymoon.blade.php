...
<div class="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-rose-600 to-rose-500 py-3 px-4 z-50 shadow-lg" id="sticky-cta">
    <div class="container mx-auto flex items-center justify-between">
        <div class="text-white">
            <span class="font-semibold text-lg hidden sm:inline">Ready to book your honeymoon escape?</span>
            <span class="font-semibold text-lg sm:hidden">Book now!</span>
        </div>
        <a href="{{ route('package-builder') }}" 
           class="bg-white text-rose-600 px-6 py-2 rounded-lg font-bold hover:bg-gray-100 transition-colors duration-300 flex items-center gap-2 shadow-md">
