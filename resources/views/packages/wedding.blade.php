...
@section('meta_description', 'Luxury wedding packages at Soba Lanka Resort. Elegant venues, accommodations, catering and stunning settings for your dream wedding in Kurunegala, Sri Lanka.')
...
<div class="relative z-0 pt-20">
    ...
    <div class="bg-center bg-cover relative" style="background-image: url('{{ asset('images/wedding-bg.jpg') }}')">
        ...
        <div class="container mx-auto px-4 py-24 relative">
            <h1 class="text-center text-5xl mb-4 opacity-0 animate-fade-in-up"><span class="gradient-text">WEDDING PACKAGES</span></h1>
...
<div class="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-amber-600 to-amber-500 py-3 px-4 z-50 shadow-lg" id="sticky-cta">
    <div class="container mx-auto flex items-center justify-between">
        <div class="text-white">
            <span class="font-semibold text-lg hidden sm:inline">Ready to plan your dream wedding?</span>
            <span class="font-semibold text-lg sm:hidden">Book now!</span>
        </div>
        <a href="{{ route('package-builder') }}" 
           class="bg-white text-amber-600 px-6 py-2 rounded-lg font-bold hover:bg-gray-100 transition-colors duration-300 flex items-center gap-2 shadow-md">
