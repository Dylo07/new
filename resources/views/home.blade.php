            ...
            <div class="relative">
                ...
                <div class="text-center mb-12 opacity-0 animate-fade-in-up">
                    <h1 class="text-4xl md:text-6xl font-heavy text-white mb-6 tracking-tight">
                        ...
                        <span
                            class="text-2xl md:text-4xl text-white font-modern font-thin tracking-widest uppercase mt-2 block">Holiday
                            Resort</span>
                    </h1>
                ...
                <div id="booking-section"
                    class="max-w-5xl mx-auto glass p-6 md:p-10 rounded-2xl shadow-2xl opacity-0 animate-fade-in-up stagger-2">
                    <div class="text-white text-lg mb-8 text-center font-medium tracking-widest uppercase">Night Stay & Day
                        Out Packages</div>

                    <form action="{{ route('package-builder') }}" method="GET"
                        ...
                        <div>
                            ...
                            <input type="date" name="check_in" id="check_in"
                                class="w-full p-3.5 rounded-xl input-modern text-white font-medium" required
                        ...
                        <div>
                            ...
                            <input type="number" name="adults" min="1" value="{{ old('adults', 2) }}"
                                class="w-full p-3.5 rounded-xl input-modern text-white font-medium" required
        ...
        <div class="container mx-auto px-4 py-24 relative z-10">
            <div class="flex flex-col md:flex-row items-center gap-12">
                ...
                <div class="w-full md:w-1/2 relative overflow-hidden rounded-2xl group">
                    <img src="{{ asset('images/pool-night.jpg') }}" alt="Luxury Pool at Night"
                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <div class="text-center mt-8">
                        <a href="{{ route('calendar.index') }}"
                            class="bg-emerald-500 text-white px-6 py-3 rounded-lg hover:bg-emerald-600 transition-all duration-300">
    ...
    <section class="relative z-10 bg-black">
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="relative group overflow-hidden">
                <img src="{{ asset('images/deluxe-suite-min.jpg') }}" alt="Deluxe Suite"
                    class="w-full h-96 object-cover rounded-lg transition-transform duration-300 group-hover:scale-105">
                <div
                    class="absolute inset-0 bg-black bg-opacity-40 transition-opacity duration-300 group-hover:bg-opacity-30">
                </div>
            ...
            <!-- Signature Suite -->
            <div class="relative group overflow-hidden">
                <img src="{{ asset('images/signature-suite-min.jpg') }}" alt="Signature Suite"
                    class="w-full h-96 object-cover rounded-lg transition-transform duration-300 group-hover:scale-105">
                <div
                    class="absolute inset-0 bg-black bg-opacity-40 transition-opacity duration-300 group-hover:bg-opacity-30">
                </div>
            ...
            <!-- Luxury Suite -->
            <div class="relative group overflow-hidden">
                <img src="{{ asset('images/luxury-suite-min.jpg') }}" alt="Luxury Suite"
                    class="w-full h-96 object-cover rounded-lg transition-transform duration-300 group-hover:scale-105">
                <div
                    class="absolute inset-0 bg-black bg-opacity-40 transition-opacity duration-300 group-hover:bg-opacity-30">
                </div>
            ...
            <div class="container mx-auto px-4 py-24">
                <div class="flex flex-col md:flex-row items-center justify-between gap-12">
                    ...
                    <div class="w-full md:w-1/2">
                        <img src="{{ asset('images/restaurant-dish-min.jpg') }}" alt="Gourmet Dish"
                    ...
                    <div class="container mx-auto px-4 py-24">
                        ...
                        <div class="text-center mb-16 max-w-3xl mx-auto">
                            <p class="text-white text-lg leading-relaxed">
                                Everything you need to live an unforgettable eco-luxury experience of health and well-being.
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                            ...
                            <div class="relative group overflow-hidden cursor-pointer">
                                <img src="{{ asset('images/facilities/restaurant-min.jpg') }}" alt="Restaurant"
                            ...
                            <!-- Banquet Hall -->
                            <div class="relative group overflow-hidden cursor-pointer">
                                <img src="{{ asset('images/facilities/banquet-hall-min.jpg') }}" alt="Banquet Hall"
                                    class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-110">
                                <div
                                    class="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-30 transition-all duration-300">
                                </div>
                            ...
                            <!-- Swimming Pool -->
                            <div class="relative group overflow-hidden cursor-pointer">
                                <img src="{{ asset('images/facilities/swimming-pool-min.jpg') }}" alt="Swimming Pool"
                                    class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-110">
                                <div
                                    class="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-30 transition-all duration-300">
                                </div>
                            ...
                            <!-- Pub & Bar -->
                            <div class="relative group overflow-hidden cursor-pointer">
                                <img src="{{ asset('images/pub-bar-min.jpg') }}" alt="Pub & Bar"
                                    class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-110">
                                <div
                                    class="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-30 transition-all duration-300">
                                </div>
                            ...
                            <!-- Indoor Games -->
                            <div class="relative group overflow-hidden cursor-pointer">
                                <img src="{{ asset('images/facilities/indoor-games-min.jpg') }}" alt="Indoor Games"
                                    class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-110">
                                <div
                                    class="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-30 transition-all duration-300">
                                </div>
                            ...
                            <!-- Outdoor Games -->
                            <div class="relative group overflow-hidden cursor-pointer">
                                <img src="{{ asset('images/facilities/outdoor-games-min.jpg') }}" alt="Outdoor Games"
                                    class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-110">
                                <div
                                    class="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-30 transition-all duration-300">
                                </div>
                            ...
                            <!-- Environment -->
                            <div class="relative group overflow-hidden cursor-pointer">
                                <img src="{{ asset('images/facilities/environment.jpg') }}" alt="Environment"
                                    class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-110">
                                <div
                                    class="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-30 transition-all duration-300">
                                </div>
                            ...
                            <!-- Rooms & Cottages -->
                            <div class="relative group overflow-hidden cursor-pointer">
                                <img src="{{ asset('images/facilities/rooms-cottages-min.jpg') }}" alt="Rooms & Cottages"
                                    class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-110">
                                <div
                                    class="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-30 transition-all duration-300">
                                </div>
                        ...
                        <div class="container mx-auto px-4 py-24">
                            ...
                            <div class="text-center mb-16">
                                ...
                                <h2 class="text-white text-4xl font-light mb-12 max-w-3xl mx-auto leading-relaxed">
                                    Enjoy and join the handful of guests who already sent their best photographic memories
                                    of their stay.
                                </h2>
                                ...
                                <div class="flex justify-center items-center gap-4 mb-12 flex-wrap">
                                    <a href="{{ route('gallery') }}"
                                        class="bg-emerald-500 text-white px-6 py-3 rounded-lg hover:bg-emerald-600 transition-colors duration-300">
                                        View All Gallery
                                    </a>
                                    <a href="{{ route('gallery.rooms') }}"
                                        class="bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-300">
                                        Rooms
                                    </a>
                                    <a href="{{ route('gallery.family_cottages') }}"
                                        class="bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-300">
                                        Family Cottages
                                    </a>
                                    <a href="{{ route('gallery.couple_cottages') }}"
                                        class="bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-300">
                                        Couple Cottages
                                    </a>
                                    <a href="{{ route('gallery.family_rooms') }}"
                                        class="bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-300">
                                        Family Rooms
                                    </a>
                                    <a href="{{ route('gallery.outdoor') }}"
                                        class="bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-300">
                                        Outdoor
                                    </a>
                                    <a href="{{ route('gallery.weddings') }}"
                                        class="bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-300">
                                        Weddings
                                    </a>
                                    <a href="{{ route('gallery.conference_hall') }}"
                                        class="bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-300">
                                        Conference Hall
                                    </a>
                                    <a href="{{ route('gallery.events') }}"
                                        class="bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-300">
                                        Events
                                    </a>
                                    <a href="{{ route('gallery.indoor_games') }}"
                                        class="bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-300">
                                        Indoor Games
                                    </a>
                                    <a href="{{ route('gallery.outdoor_games') }}"
                                        class="bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-300">
                                        Outdoor Games
                                    </a>
                                    <a href="{{ route('gallery.swimming_pool') }}"
                                        class="bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-300">
                                        Swimming Pool
                                    </a>
                                    <a href="{{ route('gallery.dining_area') }}"
                                        class="bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-300">
                                        Dining Area
                                    </a>
                                </div>
                                ...
                                @if($hasAnyImages)
                                    ...
                                    <x-gallery-section title="Family Cottages" route="gallery.family_cottages"
                                        :images="$familyCottageImages" />

                                    <!-- Couple Cottages Preview -->
                                    <x-gallery-section title="Couple Cottages" route="gallery.couple_cottages"
                                        :images="$coupleCottageImages" />

                                    <!-- Family Rooms Preview -->
                                    <x-gallery-section title="Family Rooms" route="gallery.family_rooms"
                                        :images="$familyRoomImages" />

                                    <!-- General Rooms Preview -->
                                    <x-gallery-section title="Hotel Rooms" route="gallery.rooms" :images="$roomImages" />

                                    <!-- Outdoor Gallery Preview -->
                                    <x-gallery-section title="Outdoor Spaces" route="gallery.outdoor"
                                        :images="$outdoorImages" />

                                    <!-- Wedding Gallery Preview -->
                                    <x-gallery-section title="Weddings & Events" route="gallery.weddings"
                                        :images="$weddingImages" />

                                    <!-- Conference Hall Preview -->
                                    <x-gallery-section title="Conference Hall" route="gallery.conference_hall"
                                        :images="$conferenceHallImages" />

                                    <!-- Events Preview -->
                                    <x-gallery-section title="Events & Celebrations" route="gallery.events"
                                        :images="$eventImages" />

                                    <!-- Indoor Games Preview -->
                                    <x-gallery-section title="Indoor Game Area" route="gallery.indoor_games"
                                        :images="$indoorGameImages" />

                                    <!-- Outdoor Games Preview -->
                                    <x-gallery-section title="Outdoor Game Area" route="gallery.outdoor_games"
                                        :images="$outdoorGameImages" />

                                    <!-- Swimming Pool Preview -->
                                    <x-gallery-section title="Swimming Pool" route="gallery.swimming_pool"
                                        :images="$swimmingPoolImages" />

                                    <!-- Dining Area Preview -->
                                    <x-gallery-section title="Dining Area" route="gallery.dining_area"
                                        :images="$diningAreaImages" />
                                @else
                                    ...
                                    <div class="text-center py-16">
                                        <div class="bg-gray-900 rounded-lg p-12 mx-auto max-w-2xl">
                                            ...
                                            <p class="text-gray-300 mb-6">
                                                We're preparing an amazing collection of photos showcasing our beautiful
                        ...
                        <div class="bg-black py-24">
                            <div class="container mx-auto px-4">
                                ...
                                <div class="text-center mb-16">
                                    ...
                                    <h2 class="text-white text-4xl font-light">Explore Our New Packages for the Perfect
                                        Holiday!</h2>
                                </div>
                                ...
                                <div class="mb-16">
                                    <div class="mb-8">
                                        ...
                                        <p class="text-gray-300">Indulge in our exclusive couple packages featuring cozy
                                            cottage accommodations, delicious meals, swimming pool access, and a variety of
                                            games for a perfect getaway</p>
                                        <a href="#"
                                            class="inline-block text-white hover:text-emerald-400 transition-colors duration-300 mt-4">View
                                            Details</a>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                        ...
                                        <div class="bg-gray-900 rounded-lg overflow-hidden">
                                            <div class="relative">
                                                <img src="{{ asset('images/packages/17.jpg') }}"
                                                    alt="Special Couple Package" class="w-full h-55 object-cover">
                                        ...
                                        <div class="bg-gray-900 rounded-lg overflow-hidden">
                                            <div class="relative">
                                                <img src="{{ asset('images/packages/16.jpg') }}" alt="Day Out Package"
                                        ...
                                        <div class="bg-gray-900 rounded-lg overflow-hidden">
                                            <div class="relative">
                                                <img src="{{ asset('images/packages/18.jpg') }}"
                                                    alt="Special Couple FB Package" class="w-full h-55 object-cover">
                        ...
                        <section class="relative z-10 bg-black">
                            <div class="mb-16">
                                <div class="mb-8">
                                    ...
                                    <p class="text-gray-300">Enjoy our family packages with cozy cottage accommodations,
                                        delicious meals, swimming pool access, and a variety of games, perfect for groups of
                                        2 to 10 guests.</p>
                                    <a href="#"
                                        class="inline-block text-white hover:text-emerald-400 transition-colors duration-300 mt-4">View
                                        Details</a>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    ...
                                    <div class="bg-gray-900 rounded-lg overflow-hidden">
                                        <div class="relative">
                                            <img src="{{ asset('images/packages/family-night.jpg') }}"
                                                alt="Family Night Stay Package" class="w-full h-55 object-cover">
                                    ...
                                    <div class="bg-gray-900 rounded-lg overflow-hidden">
                                        <div class="relative">
                                            <img src="{{ asset('images/packages/family-day.jpg') }}"
                                                alt="Family Day Out Package" class="w-full h-55 object-cover">
                                    ...
                                    <div class="bg-gray-900 rounded-lg overflow-hidden">
                                        <div class="relative">
                                            <img src="{{ asset('images/packages/family-night-2.jpg') }}"
                                                alt="Family Night Stay Package 2" class="w-full h-55 object-cover">
                            ...
                            <section class="relative z-10 bg-black">
                                <div class="mb-16">
                                    <div class="mb-8">
                                        <p class="text-gray-400">Suitable for Offices, Large Families, and Groups (10+
                                            Guests)</p>
                                        <h3 class="text-white text-3xl mb-4">Group Packages</h3>
                                        <p class="text-gray-300">Experience our group packages with cozy cottage
                                            accommodations, delicious meals, swimming pool access, and a variety of games,
                                            perfect for groups of more than 10 guests.</p>
                                        <a href="#"
                                            class="inline-block text-white hover:text-emerald-400 transition-colors duration-300 mt-4">View
                                            Details</a>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                        ...
                                        <div class="bg-gray-900 rounded-lg overflow-hidden">
                                            <div class="relative">
                                                <img src="{{ asset('images/packages/group-night.jpg') }}"
                                                    alt="Group Night Stay Package" class="w-full h-55 object-cover">
                                        ...
                                        <div class="bg-gray-900 rounded-lg overflow-hidden">
                                            <div class="relative">
                                                <img src="{{ asset('images/packages/group-night-fb.jpg') }}"
                                                    alt="Group Night Stay FB Package" class="w-full h-55 object-cover">
                                        ...
                                        <div class="bg-gray-900 rounded-lg overflow-hidden">
                                            <div class="relative">
                                                <img src="{{ asset('images/packages/Groupday.jpg') }}"
                                                    alt="Group Day Out Package" class="w-full h-55 object-cover">
                                ...
                                <section class="relative z-10 bg-black py-16">
                                    <div class="container mx-auto px-4">
                                        ...
                                        <div class="mb-16">
                                            ...
                                            <h4 class="text-white text-xl mb-4">Experience Unmatched Elegance with Our
                                                Luxury Wedding Packages</h4>
                                            <p class="text-gray-300 mb-6">Celebrate your special day in unparalleled style
                                                and sophistication with our exclusive luxury wedding packages. Our
                                                meticulously curated offerings include opulent accommodations, gourmet
                                                dining experiences, and access to our stunning swimming pool and other
                                                premium amenities.</p>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-2 gap-4 mb-8">
                                            ...
                                            <div class="relative group overflow-hidden rounded-lg">
                                                <img src="{{ asset('images/packages/wedding2.jpg') }}"
                                                ...
                                                <div class="grid md:grid-cols-2 gap-12">
                                                    ...
                                                    <div class="space-y-6">
                                                        <div class="border-b border-emerald-500 pb-4">
                                                            ...
                                                            <p class="text-gray-400 mt-2">All-inclusive luxury wedding
                                                                experience</p>
                                                        </div>
                                                    ...
                                                    <div class="space-y-8">
                                                        ...
                                                        <div class="bg-black/40 p-8 rounded-xl border border-emerald-500">
                                                            ...
                                                            <ul class="text-gray-300 space-y-4">
                                                                <li
                                                                    class="flex justify-between items-center border-b border-emerald-500 pb-3">
                                                                    <span>50 Pax</span>
                                ...
                                <section class="relative z-10 bg-black">
                                    <div class="bg-black py-24">
                                        <div class="container mx-auto px-4">
                                            <h2 class="text-brown-400 text-3xl mb-12 text-center">Frequently Asked Questions
                                            </h2>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                                                ...
                                                <div class="space-y-4">
                                                    ...
                                                    <div x-data="{ open: true }" class="border-b border-emerald-500">
                                                        ...
                                                        <div x-show="open" class="pb-4 text-gray-300">
                                                            <p>Our hotel offers accommodation for a maximum of 100 guests.
                                                            </p>
                                                            <p>Nestled within a 10-acre area surrounded by beautiful nature,
                                                                we have a variety of cottages and rooms, totaling over 30
                                                                available.</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div x-data="{ open: false }" class="border-b border-emerald-500">
                                                        ...
                                                        <div x-show="open" class="pb-4 text-gray-300">
                                                            ...
                                                            <p>Enjoy a relaxing stay at our hotel, with spacious rooms,
                                                                modern amenities, and friendly staff. Book now and get the
                                                                best rates and offers.</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div x-data="{ open: false }" class="border-b border-emerald-500">
                                                        ...
                                                        <div x-show="open" class="pb-4 text-gray-300">
                                                            <!-- Add answer content here -->
                                                            <p>Our hotel offers a variety of facilities to make your stay
                                                                comfortable and enjoyable. Some of the facilities that are
                                                                available in our hotel are,

                                                                A swimming pool where you can relax and enjoy the sun or
                                                                swim some laps.
                                                                A restaurant and bar where you can savor delicious food and
                                                                drinks.
                                                                A conference room and banquet hall where you can host
                                                                meetings, events, and parties.
                                                                Room service where you can order food and drinks to your
                                                                room anytime.
                                                                A parking garage where you can park your car safely and
                                                                conveniently.</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div x-data="{ open: false }" class="border-b border-emerald-500">
                                                        ...
                                                        <div x-show="open" class="pb-4 text-gray-300">
                                                            <!-- Add answer content here -->
                                                            <p>We offer day-out packages, night-out packages, as well as
                                                                wedding and homecoming packages. To learn more, click here
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div x-data="{ open: false }" class="border-b border-emerald-500">
                                                        ...
                                                        <div x-show="open" class="pb-4 text-gray-300">
                                                            <!-- Add answer content here -->
                                                            <p>To reserve our hotel, you can either book online through our
                                                                website or call us directly at +94 37 225 0308. You will
                                                                need to provide some basic information such as your name,
                                                                contact details, check-in and check-out dates, number of
                                                                guests, and preferred room type. You can also choose from
                                                                various payment options such as credit card, debit card, or
                                                                cash. You will receive a confirmation email or SMS once your
                                                                reservation is complete. If you have any questions or
                                                                special requests, please feel free to contact us anytime. We
                                                                look forward to welcoming you at our hotel</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <!-- Image Section -->
                                                <div class="relative">
                                                    <img src="{{ asset('images/chef-cooking-min.jpg') }}"
                                                ...
                                                <div class="space-y-8">
                                                    ...
                                                    <div class="space-y-6">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-white">
                                                                Soba Lanka Holiday Resort PVT (LTD), Balawattala Road,
                                                                Melsiripura 60540
                                                            </p>
                                                        </div>
                                                        ...
                                                        <div class="flex items-center space-x-4">
                                                            <div class="flex items-center">
                                                                ...
                                                                <div class="flex text-yellow-400">
                                                                    ...
                                                                    <svg class="w-5 h-5 text-yellow-400/50"
                                                            ...
                                                            <a href="https://maps.app.goo.gl/3UzGke3yVHaBMU7WA"
                                                                target="_blank"
                                                                class="text-blue-400 hover:text-blue-300">(365)</a>
                                                        </div>

                                                        <!-- Directions Button -->
                                                        <a href="https://maps.app.goo.gl/99iFNphobJ9DFyq99" target="_blank"
                                    ...
                                    <section class="relative z-10 bg-black">
                                        <div class="relative bg-black">
                                            ...
                                            <div class="absolute inset-0">
                                                <img src="{{ asset('images/pool-bg-min.jpg') }}" alt="Swimming Pool"
                                            ...
                                            <div class="relative container mx-auto px-4 py-24 text-center">
                                                ...
                                                <p class="text-white text-lg mb-8">
                                                    Questions or feedback? Reach out to us. We're here to assist you
