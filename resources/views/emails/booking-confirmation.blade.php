                ...
                <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px 20px 30px; text-align: center;">
                            ...
                            <p style="color: #6b7280; margin: 0; font-size: 16px;">Thank you for choosing Soba Lanka Hotel</p>
                        </td>
                    </tr>
                        ...
                        <td style="padding: 0 30px 30px 30px;">
                            <table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #f9fafb; border-radius: 8px; overflow: hidden;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 15px 20px; border-bottom: 1px solid #e5e7eb; color: #1f2937; font-size: 14px; font-weight: 600; text-align: right;">{{ $package->name }}</td>
                                </tr>
                                <tr>
                            ...
                            <table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #fef3c7; border-radius: 8px; border: 1px solid #fcd34d;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <h4 style="color: #92400e; margin: 0 0 15px 0; font-size: 14px; font-weight: 600;">💳 Payment Information</h4>
                                        <p style="color: #78350f; margin: 0 0 5px 0; font-size: 13px;"><strong>Method:</strong> {{ ucfirst(str_replace('_', ' ', $booking->payment_method)) }}</p>
                                        <p style="color: #78350f; margin: 0; font-size: 13px;"><strong>Status:</strong> {{ $booking->payment_receipt ? 'Receipt Uploaded' : 'Awaiting Receipt' }}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 0 30px 30px 30px;">
                            <table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #eff6ff; border-radius: 8px; border: 1px solid #bfdbfe;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <h4 style="color: #1e40af; margin: 0 0 15px 0; font-size: 14px; font-weight: 600;">🏦 Bank Account Details</h4>
                                        ...
                                        <p style="color: #dc2626; margin: 15px 0 0 0; font-size: 12px; font-weight: 600;">
                                            ⚠️ Please use Booking #{{ $booking->id }} as your payment reference.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding: 0 30px 30px 30px; text-align: center;">
                            ...
                            <p style="color: #9ca3af; margin: 15px 0 0 0; font-size: 12px;">
                                Upload your payment receipt from your profile page
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: #1f2937; padding: 30px; text-align: center;">
                            ...
                            <p style="color: #6b7280; margin: 0; font-size: 12px;">
                                © {{ date('Y') }} Soba Lanka Holiday Resort. All rights reserved.
                            </p>
                        </td>
                    </tr>
