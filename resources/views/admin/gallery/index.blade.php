    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-6">
                <h2 class="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Room Gallery</h2>
                <p class="text-gray-600 dark:text-gray-300 mb-4">Manage images of hotel rooms and suites.</p>
