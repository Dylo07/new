    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-6">
                ...
                <a href="{{ route('admin.gallery.rooms') }}" class="inline-block bg-emerald-500 text-white px-4 py-2 rounded hover:bg-emerald-600 transition-colors">
                    Manage Images
                </a>
            </div>
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-6">
                ...
                <a href="{{ route('admin.gallery.family-cottages') }}" class="inline-block bg-emerald-500 text-white px-4 py-2 rounded hover:bg-emerald-600 transition-colors">
                    Manage Images
                </a>
            </div>
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-6">
                ...
                <a href="{{ route('admin.gallery.couple-cottages') }}" class="inline-block bg-emerald-500 text-white px-4 py-2 rounded hover:bg-emerald-600 transition-colors">
                    Manage Images
                </a>
            </div>
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-6">
                ...
                <a href="{{ route('admin.gallery.family-rooms') }}" class="inline-block bg-emerald-500 text-white px-4 py-2 rounded hover:bg-emerald-600 transition-colors">
                    Manage Images
                </a>
            </div>
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-6">
                ...
                <a href="{{ route('admin.gallery.outdoor') }}" class="inline-block bg-emerald-500 text-white px-4 py-2 rounded hover:bg-emerald-600 transition-colors">
                    Manage Images
                </a>
            </div>
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-6">
                ...
                <a href="{{ route('admin.gallery.weddings') }}" class="inline-block bg-emerald-500 text-white px-4 py-2 rounded hover:bg-emerald-600 transition-colors">
                    Manage Images
                </a>
            </div>
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-6">
                ...
                <a href="{{ route('admin.gallery.conference-hall') }}" class="inline-block bg-emerald-500 text-white px-4 py-2 rounded hover:bg-emerald-600 transition-colors">
                    Manage Images
                </a>
            </div>
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-6">
                ...
                <a href="{{ route('admin.gallery.events') }}" class="inline-block bg-emerald-500 text-white px-4 py-2 rounded hover:bg-emerald-600 transition-colors">
                    Manage Images
                </a>
            </div>
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-6">
                ...
                <a href="{{ route('admin.gallery.indoor-games') }}" class="inline-block bg-emerald-500 text-white px-4 py-2 rounded hover:bg-emerald-600 transition-colors">
                    Manage Images
                </a>
            </div>
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-6">
                ...
                <a href="{{ route('admin.gallery.outdoor-games') }}" class="inline-block bg-emerald-500 text-white px-4 py-2 rounded hover:bg-emerald-600 transition-colors">
                    Manage Images
                </a>
            </div>
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-6">
                ...
                <a href="{{ route('admin.gallery.swimming-pool') }}" class="inline-block bg-emerald-500 text-white px-4 py-2 rounded hover:bg-emerald-600 transition-colors">
                    Manage Images
                </a>
            </div>
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-6">
                ...
                <a href="{{ route('admin.gallery.dining-area') }}" class="inline-block bg-emerald-500 text-white px-4 py-2 rounded hover:bg-emerald-600 transition-colors">
                    Manage Images
                </a>
            </div>
        </div>
