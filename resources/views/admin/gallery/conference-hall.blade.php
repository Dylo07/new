<!-- resources/views/admin/gallery/conference-hall.blade.php -->
@extends('layouts.app')

@section('title', 'Manage Conference Hall Gallery')

@section('content')
<div class="container mx-auto px-4 py-8">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Conference Hall Gallery</h1>
        ...
        <div class="mb-8 bg-gray-100 dark:bg-gray-700 p-6 rounded-lg">
            ...
            <form action="{{ route('admin.gallery.upload') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
                <input type="hidden" name="gallery_type" value="conference_hall">
