...
<div class="relative gallery-dropdown-container">
    ...
    <div class="gallery-dropdown-menu absolute hidden left-0 mt-0 pt-2 w-48 z-50">
        ...
        <div class="bg-black border border-gray-700 rounded-lg shadow-xl overflow-hidden">
            <a href="{{ route('gallery') }}" class="block px-4 py-2 text-sm text-white hover:bg-green-600 transition-colors duration-200">
                All Photos
            </a>
            <a href="{{ route('gallery.rooms') }}" class="block px-4 py-2 text-sm text-white hover:bg-green-600 transition-colors duration-200">
                Room Gallery
            </a>
            <a href="{{ route('gallery.outdoor') }}" class="block px-4 py-2 text-sm text-white hover:bg-green-600 transition-colors duration-200">
                Outdoor Gallery
            </a>
            <a href="{{ route('gallery.weddings') }}" class="block px-4 py-2 text-sm text-white hover:bg-green-600 transition-colors duration-200">
                Weddings Gallery
            </a>
        </div>
    </div>
</div>
<!-- Packages Dropdown - Updated -->
<div class="relative packages-dropdown-container">
    ...
    <div class="packages-dropdown-menu absolute hidden left-0 mt-0 pt-2 w-48 z-50">
        ...
        <div class="bg-black border border-gray-700 rounded-lg shadow-xl overflow-hidden">
            ...
            <a href="{{ route('packages.family') }}" class="block px-4 py-2 text-sm text-white hover:bg-purple-600 transition-colors duration-200">
                Family Packages
            </a>
            <a href="{{ route('packages.group') }}" class="block px-4 py-2 text-sm text-white hover:bg-green-600 transition-colors duration-200">
                Group Packages
            </a>
            <a href="{{ route('packages.wedding') }}" class="block px-4 py-2 text-sm text-white hover:bg-purple-600 transition-colors duration-200">
                Wedding Packages
            </a>
            <a href="{{ route('packages.engagement') }}" class="block px-4 py-2 text-sm text-white hover:bg-pink-600 transition-colors duration-200">
                Engagement Packages
            </a>
            <a href="{{ route('packages.birthday') }}" class="block px-4 py-2 text-sm text-white hover:bg-yellow-600 transition-colors duration-200">
                Birthday Packages
            </a>
            <a href="{{ route('packages.honeymoon') }}" class="block px-4 py-2 text-sm text-white hover:bg-red-600 transition-colors duration-200">
                Honeymoon Packages
            </a>
        </div>
    </div>
...
<!-- Mobile Packages Dropdown -->
                        <div id="mobilePackagesLinks" class="hidden pl-4 mt-2 space-y-2 border-l border-gray-700">
                            ...
                            <a href="{{ route('packages.family') }}" class="block text-white hover:text-purple-400 transition-colors duration-300">
                                Family Packages
                            </a>
                            <a href="{{ route('packages.group') }}" class="block text-white hover:text-green-400 transition-colors duration-300">
                                Group Packages
                            </a>
                            <a href="{{ route('packages.wedding') }}" class="block text-white hover:text-purple-400 transition-colors duration-300">
                                Wedding Packages
                            </a>
                            <a href="{{ route('packages.engagement') }}" class="block text-white hover:text-rose-400 transition-colors duration-300">
                                Engagement Packages
                            </a>
                            <a href="{{ route('packages.birthday') }}" class="block text-white hover:text-yellow-400 transition-colors duration-300">
                                Birthday Packages
                            </a>
                            <a href="{{ route('packages.honeymoon') }}" class="block text-white hover:text-red-400 transition-colors duration-300">
                                Honeymoon Packages
                            </a>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('click', function(event) {
                // Close gallery dropdown if clicking outside
                ...
                // Close packages dropdown if clicking outside
