...
<body>
    ...
    <div class="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-black/95 backdrop-blur-md border-t border-gray-800 p-3 flex items-center gap-3" id="mobileBookBar">
        <div class="flex-1">
            <p class="text-white text-sm font-semibold">Soba Lanka Resort</p>
            <p class="text-emerald-400 text-xs">From Rs.2,490/person</p>
        </div>
        <a href="{{ route('package-builder') }}" class="btn-primary text-white px-6 py-3 rounded-xl font-bold text-sm flex items-center gap-2 whitespace-nowrap">
