<!-- resources/views/gallery/family-rooms.blade.php -->
@extends('layouts.app')

@section('title', 'Family Rooms Gallery')
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            @empty
                <div class="col-span-4 text-center py-12">
                    <p class="text-white text-xl">No family room gallery images available yet.</p>
                </div>
            @endforelse
        </div>
    </div>
