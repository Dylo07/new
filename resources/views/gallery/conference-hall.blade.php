<!-- resources/views/gallery/conference-hall.blade.php -->
@extends('layouts.app')

@section('title', 'Conference Hall Gallery')
...
<div class="relative z-0 pt-20">
    ...
    <div class="relative w-full h-96">
        ...
        <div class="absolute inset-0 bg-black bg-opacity-70 flex flex-col justify-center items-center">
            <h1 class="text-5xl mb-4 text-center opacity-0 animate-fade-in-up"><span class="gradient-text">CONFERENCE HALL GALLERY</span></h1>
            <p class="text-white text-xl text-center">
                Professional conference halls and meeting spaces for your business events.
            </p>
        </div>
    </div>
</div>
...
<div class="bg-black py-24">
    <div class="container mx-auto px-4">
        ...
        <div class="flex justify-center items-center gap-4 mb-8 flex-wrap">
            ...
            <a href="{{ route('gallery.conference_hall') }}" class="bg-emerald-500 text-white px-4 py-2 rounded-lg">
                Conference Hall
            </a>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            @empty
                <div class="col-span-4 text-center py-12">
                    <p class="text-white text-xl">No conference hall gallery images available yet.</p>
                </div>
            @endforelse
        </div>
    </div>
