<!-- resources/views/gallery/indoor-games.blade.php -->
@extends('layouts.app')

@section('title', 'Indoor Game Area Gallery')
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            @empty
                <div class="col-span-4 text-center py-12">
                    <p class="text-white text-xl">No indoor game area gallery images available yet.</p>
                </div>
            @endforelse
        </div>
    </div>
