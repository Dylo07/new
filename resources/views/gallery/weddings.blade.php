<!-- resources/views/gallery/weddings.blade.php -->
@extends('layouts.app')

@section('title', 'Weddings Gallery')
...
<div class="relative z-0 pt-20">
    ...
    <div class="relative w-full h-96">
        ...
        <div class="absolute inset-0 bg-black bg-opacity-70 flex flex-col justify-center items-center">
            <h1 class="text-5xl mb-4 text-center opacity-0 animate-fade-in-up"><span class="gradient-text">WEDDINGS GALLERY</span></h1>
            <p class="text-white text-xl text-center">
                Celebrate your special day in our stunning venue with beautiful memories.
            </p>
        </div>
    </div>
</div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            @empty
                <div class="col-span-4 text-center py-12">
                    <p class="text-white text-xl">No wedding gallery images available yet.</p>
                </div>
            @endforelse
        </div>
    </div>
